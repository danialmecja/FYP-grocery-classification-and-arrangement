...
def take_picture():
    cam = cv2.VideoCapture(2) # camport = 2 for jupiter 
...
def main():
    ...
    # Read file
    #img_path = '/home/mustar/mad_fyp/FYP-grocery-classification-and-arrangement/grocery-size-estimation/imagefiles/sample1.jpg'
    ...
    output = get_size(ori_img, prep_img, 5.0)
